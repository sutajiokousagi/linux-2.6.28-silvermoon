/*
 *  drivers/video/cbp_pxafb_overlay.c
 *  (was: linux-2.6.25/drivers/video/pxafb_overlay.c)
 *
...
#include <asm/arch/pxa2xx_v4l2ov2.h>
#include "cbp_pxafb.h"
...
#if defined(CONFIG_MACH_CHUMBY_STORMWIND)
static int  null_soft_cursor(struct fb_info *info, struct fb_cursor *cursor)
{
	return 0;
}
#else

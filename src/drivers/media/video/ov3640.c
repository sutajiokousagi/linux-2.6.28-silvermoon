...
static int ov3640_g_register(struct i2c_client *client, struct v4l2_register * reg)
{
	return ov3640_read(client, (u16)reg->reg, (unsigned char *)&(reg->val));
}

static int ov3640_s_register(struct i2c_client *client, struct v4l2_register * reg)
{
		...
		void *arg)
{
	switch (cmd) {
		...
		case VIDIOC_DBG_G_REGISTER:
			return ov3640_g_register(client, (struct v4l2_register *) arg);
		case VIDIOC_DBG_S_REGISTER:
			return ov3640_s_register(client, (struct v4l2_register *) arg);
#endif
	}
	return -EINVAL;
}

...
static int ov7670_g_register(struct i2c_client *client, struct v4l2_register * reg)
{
	return ov7670_read(client, (unsigned char)reg->reg, (unsigned char *)&(reg->val));
}

static int ov7670_s_register(struct i2c_client *client, struct v4l2_register * reg)
{
		...
		void *arg)
{
	switch (cmd) {
		...
		case VIDIOC_DBG_G_REGISTER:
			return ov7670_g_register(client, (struct v4l2_register *) arg);
		case VIDIOC_DBG_S_REGISTER:
			return ov7670_s_register(client, (struct v4l2_register *) arg);
#endif
	}
	return -EINVAL;
}

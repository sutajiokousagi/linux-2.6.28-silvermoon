...
static struct regval_list siv120a_fmt_rgb565[] = {
};
...
static int siv120a_g_register(struct i2c_client *client, struct v4l2_register * reg)
{
	return siv120a_read(client, (unsigned char)reg->reg, (unsigned char *)&(reg->val));
}

static int siv120a_s_register(struct i2c_client *client, struct v4l2_register * reg)
{
		...
		void *arg)
{
	switch (cmd) {
		...
		case VIDIOC_DBG_G_REGISTER:
			return siv120a_g_register(client, (struct v4l2_register *) arg);
		case VIDIOC_DBG_S_REGISTER:
			return siv120a_s_register(client, (struct v4l2_register *) arg);
#endif
		default:

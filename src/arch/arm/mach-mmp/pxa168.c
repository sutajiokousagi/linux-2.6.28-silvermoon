...
static APBC_CLK(pwm0, PXA168_PWM0, 0, 13000000);	
static APBC_CLK(pwm1, PXA168_PWM1, 0, 13000000);	
static APBC_CLK(pwm2, PXA168_PWM2, 0, 13000000);	
static APBC_CLK(pwm3, PXA168_PWM3, 0, 13000000);	

static APMU_CLK(nand, NAND, 0x1DB, 78000000);
...
static APMU_CLK(ccic_dbg, CCIC_DBG, 0x02000000, 0);
...
static struct clk_lookup pxa168_clkregs[] = {
	...
	INIT_CLKREG(&clk_uart3, "pxa2xx-uart.2", "UART3CLK"),
	...
	INIT_CLKREG(&clk_ccic_dbg, "pxa168-camera", "CCICDBGCLK"),

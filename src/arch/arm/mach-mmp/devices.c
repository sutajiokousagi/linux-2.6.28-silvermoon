...
PXA168_DEVICE(sdh0, "pxa-sdh", 0, MMC, 0xd4280000, 0x100);
PXA168_DEVICE(sdh1, "pxa-sdh", 1, MMC, 0xd4281000, 0x100);
...
static u64 u2oehci_dma_mask = ~(u32)0;
...
struct platform_device pxa168_device_battery = {
	.name		= "pxa168-battery",
	.id		= -1,
};

...
#define TMR_WCR_OFFSET		0x0098	     /* Timer Watchdog Counter Reset Register */
#define TMR_WFAR_OFFSET		0x009C	     /* Timer Watchdog First Access Register */
#define TMR_WSAR_OFFSET		0x00A0	     /* Timer Watchdog Second Access Register */
#define TMR_CVWR0_OFFSET	0x00A4	     /* Timer Counters Value Write for Read Request */

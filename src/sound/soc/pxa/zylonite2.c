...
static void zyloniteii_wm8753_hifi_shutdown(struct snd_pcm_substream *substream)
{
...
static void zyloniteii_wm8753_voice_shutdown(struct snd_pcm_substream *substream)
{
